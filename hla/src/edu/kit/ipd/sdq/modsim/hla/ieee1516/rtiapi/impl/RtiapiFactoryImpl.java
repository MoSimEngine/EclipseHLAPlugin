...
public class RtiapiFactoryImpl extends EFactoryImpl implements RtiapiFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case RtiapiPackage.HLA_FEDERATE_AMBASSADOR:
				return createHLAFederateAmbassadorFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case RtiapiPackage.HLA_FEDERATE_AMBASSADOR:
				return convertHLAFederateAmbassadorToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public FederateAmbassador createHLAFederateAmbassadorFromString(EDataType eDataType, String initialValue) {
		return (FederateAmbassador)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertHLAFederateAmbassadorToString(EDataType eDataType, Object instanceValue) {
